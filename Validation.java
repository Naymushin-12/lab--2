...
public class Validation {
    ...
    public static String getNamesErrorMessage(String lastName, String firstName, String patronymic) { // проверка что
                                                                                                      // хотя бы одно из
                                                                                                      // трех имен
                                                                                                      // (фамилия, имя,
                                                                                                      // отчество)
    ...
    public static String getCreatingNameErrorMessage(String firstName) { // специфичная проверка для класса CreatingName
                                                                         // - проверяет только имя
